...
const Schedule = () => {
  ...
  if (currentWeek === 2 || currentWeek === 4) {
    piketGroup = [
      ["Nicolas", "Erland", "Aulia", "Almira", "Afandi"],
      ["Hafizh", "Cahya", "Catur", "Azzam", "Rezza"],
      ["Khalil", "Rafa", "Zafar", "Nia", "Mysha", "Luri"],
      ["Raihan", "Rohmat", "Neysya", "Nikita", "Neysha"],
      ["Rafael", "Cheryl", "Rahma", "Chandra", "Rizky"],
      ["Widhinta", "Malik", "Alfian", "Tevy", "Irfan"],
    ];
