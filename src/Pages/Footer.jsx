					...
					<div class="grid grid-cols-2 sm:grid-cols-3">
						<div className=" ">
							...
							<ul class="text-gray-400 dark:text-gray-400 font-medium">
								<li class="mb-2">
									<a href="https://www.instagram.com/rezzaaagg/?hl=id" class="hover:underline">
										Rezza
									</a>
								</li>
								<li>
									<a href="https://www.instagram.com/zkrzaa/?hl=id" class="hover:underline">
										Zkrrz
									</a>
								</li>
							</ul>
						...
						<div className="">
							...
							<ul class="text-gray-400 dark:text-gray-400 font-medium">
								<li class="mb-2">
									<a href="https://www.instagram.com/8begreat_/?hl=id" class="hover:underline">
										Instagram
									</a>
								</li>
								<li>
									<a href="https://www.tiktok.com/@8begreat_" class="hover:underline">
										TikTok
									</a>
								</li>
							</ul>
				...
				<div class="sm:flex sm:items-center sm:justify-between">
					<div class="flex mt-4 justify-center sm:mt-0">
						<p className="text-[0.7rem] text-white opacity-70">
							© {new Date().getFullYear()} Kelas VIII B | Di Kelola Oleh Siswa VIII B
							© @ekizr_
						</p>
					</div>
				</div>
